    ...
    <ul class="sidebar-nav" >
      ...
      <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#">
        ...
        <ul class="dropdown-menu" role="menu">
          <li><a href="financeInFlow" style="color:#0000ff">Cash Inflow</a></li>
      <li><a href="financeOutFlow" style="color:#0000ff">Cash Outflow</a></li>
    </ul>
    </li>
    </ul>
  </div>
        ...
        <div class="row">
          <div class="col-lg-12" >
            ...
            <table width="100%" align="center" border="2pt" class="table">
              ...
              <c:forEach items="${inflows}" var="inflows">
                <tr onclick="show('popDiv');">
                  <td>${inflows.date}</td>
                  <td>${inflows.requestNo}</td>
                  <td>${inflows.department}</td>
                  <td>${inflows.description}</td>
                  <td>${inflows.amount}</td>
