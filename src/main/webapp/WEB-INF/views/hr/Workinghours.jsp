    ...
    <div class="sidebar-collapse">
      <ul class="nav" id="main-menu">
        ...
        <li>
          ...
          <a href="Finance.jsp"><i class="fa fa-table"></i> Employee</a>
        </li>
        <li>
        ...
        <li>
          <a class="active-menu" href="Workinghours.jsp"><i class="fa fa-dashboard"></i> Working Hours</a>
