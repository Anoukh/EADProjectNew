            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" >
                        ...
                        <form name="AddWorkInProgress" id="addWorkInProgress" action="/addWIP" method="POST">
                            <div class="form-group col-lg-4">
                                <label for="listOfEngines">Select Engine</label>
                                <select class="form-control" name="engine_id" id="listOfEngines">
                                    <option disabled selected> --Select One-- </option>
                                    <c:forEach items="${engines}" var="engine">
                                        <option value="${engine.engineID}">${engine.engine_name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="noOfUnits">Number of Units</label>
                                <input class="form-control" type="text" name="no_of_units" id="noOfUnits" placeholder="Number of Units">
                            </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control" name="ListOfWIP" id="listOfWIP">
                                        ...
                                        <c:forEach items="${stocks}" var="stock">
                                            <option value="${stock.engine_id}">${stock.engineName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group col-lg-4">
